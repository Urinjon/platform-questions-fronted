...
import { ChevronRight, HelpCircle, Clock, MessageSquare } from "lucide-react";
			...
			{questions.map((q, index) => (
				...
				>
					<button
						...
						className={cn(
							"group w-full relative flex items-center outline-none gap-4 rounded-xl border bg-card/70 p-4.5",
